...
@section('content')
    <section class="section">
        <div class="section-header"  style="max-height: 3rem;">
            <h5 class="page__heading">Editar caja terminal</h5>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            {{-- inicio --}}
                                <form id="form" action=" {{url('/mapa-interactivo/cajaterminal/'.$caja->id)}} " method="post">
                                    @csrf
                                    {{ method_field('PATCH')}}   
                                <div class="container">
                                  <div class="row">
                                    <div class="col-sm">
                                     ...
                                     <div class="col-xs-12 col-sm-12 col-md-12">
                                      <div class="form-group">
                                         ...
                                         <input  value="{{ $caja->descripcion }}" required placeholder="Ingresar de descripcion" style="font-size:14px;" class="form-control" type="text" name="descripcion" id="descripcion">
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                      <div class="form-group">
                                         ...
                                         <select required class="form-control" id="fk_id_armario" name="fk_id_armario">
                                            <option value="{{ $caja->fk_id_armario }}">{{ $caja->armarios->numeroArmario }}</option>
                                    ...
                                    <div class="col-sm">
                                      ...
                                      <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                           ...
                                           <input value="{{ $caja->gps_caja_terminal }}" required placeholder="Ingresar gps de caja terminal" style="font-size:14px;" class="form-control" type="text" name="gps_caja_terminal" id="gps_caja_terminal">
                                         </div>
                                      </div>
                                        ...
                                        <div class="form-group">
                                          <label  style="font-size:16px; font-weight:bold; color:rgb(92, 92, 92)"  for="direccion" required>Direccion:</label>
                                           <select required class="form-control" id="direccion" name="direccion">
                                            <option value="{{ $caja->direccion }}">{{ $caja->direccion }}</option>
                                               ...
                                               <div class="col-xs-12 col-sm-12 col-md-12">
                                                <ul class="list-unstyled">
                                                    <div class="media-body">
                                                      ...
                                                      <a href="{{ route('cajaterminal.index') }}" class="btn btn-danger" id="botonCancelar"  type="button"  style="font-size: 12px"><i style="font-size: 15px" class="fa fa-times" aria-hidden="true"></i> Cancelar</a>
                                                    </div>
                                                  </ul>
                                                </div>
                                         </form>
