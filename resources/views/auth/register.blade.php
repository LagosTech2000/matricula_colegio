                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="firstName" type="text"
                                   ...
                                   name="name"
                                   tabindex="1" placeholder="un nombre y un apellido" value="{{ old('name') }}"
                                   autofocus required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="email" type="email"
                                   ...
                                   placeholder="Ingrese un correo" name="email" tabindex="1"
                                   value="{{ old('email') }}"
                                   required autofocus>
                            <div class="invalid-feedback">
                                {{ $errors->first('email') }}
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="password" type="password"
                                   ...
                                   placeholder="Ingrese una contraseña" name="password" tabindex="2" required>
                            <div class="invalid-feedback">
