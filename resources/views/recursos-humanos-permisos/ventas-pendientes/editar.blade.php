                            ...
                            {{-- inicio --}}
                              ...
                              <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                 ...
                                 <form action=" {{url('/recursos-humanos-permisos/ventas-pendientes/'.$permiso->id)}} " method="post">
                                  @csrf   
                                  {{ method_field('PATCH')}} 
                    ...
                    <div class="container">
                             ...
                             <hr>
                                    ...
                                    <div class="media-body">
                                     ...
                                     <a href="{{ route('ventas-pendientes.index') }}" class="btn btn-danger" id="botonCancelar"  type="button"  style="font-size: 12px"><i style="font-size: 15px" class="fa fa-times" aria-hidden="true"></i> Cancelar</a>
