<div class="d-flex">
    @can('recursos-humanos-ver') <a href="{{ route('administrativo-pendiente.edit',$data->id) }}" class="btn btn-primary btn-sm" type="button" style="margin-right: 0.3rem">Confirmar</a>
    @endcan
