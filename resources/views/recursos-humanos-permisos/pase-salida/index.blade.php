...
@endsection
  @section('content')
    <section class="">
      ...
      <h5 style="background-color:white; padding:0.4rem; border-radius:1rem;" id="paseSalidaMensaje">pases de salida almacenados:</h5>
  ...
  $('#order_table').DataTable({
   ...
   buttons: [{
      ...
      },
      {
                    ...
                    {
        margin: [4, 4],
        text: 'Pases de salida aprobados: del ' + '(' + from_date + ')' +' al '+'(' + to_date + ')',
        fontSize: 12,
        alignment: 'left',
      },
