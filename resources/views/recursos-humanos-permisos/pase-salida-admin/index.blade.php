  ...
  @section('content')
    <section class="section">
      <div class="section-header" style="max-height: 3rem;">
        ...
        <h5 class="page__heading">Aprobar permisos:</h5>
      </div>
                   ...
                   <table  class="table table-striped table-bordered table-sm" style="width:100%; border:2px;" id="order_table">
                     <thead style="background-color:#315d9a;">
                       <tr>          
                         ...
                         <th style="color: #fff;">Tipo de permiso</th>
...
$(document).ready(function(){
 ...
 function load_data(from_date = '', to_date = '')
 {
  ...
  //  select: true,
   ...
   autoWidth: true,
   ajax: {
    url:'{{ route("pase-salida-admin.index") }}',
   ...
   columns: [
    ...
    {
     data:'permisos.tipoPermiso',
     name:'permisos.tipoPermiso'
    },
    {
