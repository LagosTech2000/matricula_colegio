            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            {{-- inicio --}}
                            <form action=" {{url('/atencion-al-cliente/cancelaciones/'.$registro->id)}} " method="post">
                                @csrf
                                {{method_field('PATCH')}}
                                <div class="container">
                                  <div class="row">
                                    ...
                                    <div class="col-sm">
                                      ...
                                      <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                           ...
                                           <input value="{{$registro->nota}}" style="font-size:14px;" class="form-control" type="text" name="nota" id="nota">
                                         </div>
                                      </div>
                                      ...
                                      <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                           ...
                                           <input value="{{$registro->fechaCancelacion}}" style="font-size:14px;" class="form-control" type="text" name="fechaCancelacion" id="fechaCancelacion">
                                         </div>
                                      </div>
